...
const Branding = () => {
  return (
    <div className='flex flex-wrap space-y-5 space-x-5 justify-around text-center p-3'>
        <div className='border border-slate-100 bg-slate-100 justify-between space-y-4 p-10 md:w-1/3'>
        ...
        <div className='border border-slate-100 space-y-4 w-[88vw] p-10 md:w-1/3 bg-slate-100 '>
          <div><FaBus className=' border text-white bg-slate-100 border-slate-200 rounded-full p-1 m-auto animate-bounce' color='pink' size={40}/></div>
          <div className='text-2xl font-semibold'>Free Shipping</div>
          <div className='text-sm  '>We ship all over india for FREE.</div>
        </div>
        <div className='border border-slate-100 bg-slate-100 space-y-3 p-10 md:w-1/3 '>
